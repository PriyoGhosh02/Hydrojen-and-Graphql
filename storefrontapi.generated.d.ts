...
export type BundleCollectionsQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;

export type BundleCollectionsQuery = {
  watchCollection?: StorefrontAPI.Maybe<{
    products: {
      nodes: Array<
        Pick<StorefrontAPI.Product, 'id' | 'title' | 'handle'> & {
          featuredImage?: StorefrontAPI.Maybe<
  ...
  braceletCollection?: StorefrontAPI.Maybe<{
    products: {
      nodes: Array<
        Pick<StorefrontAPI.Product, 'id' | 'title' | 'handle'> & {
          featuredImage?: StorefrontAPI.Maybe<
...
interface GeneratedQueryTypes {
  ...
  '#graphql\n    query BundleCollections($country: CountryCode, $language: LanguageCode)\n    @inContext(country: $country, language: $language) {\n      watchCollection: collection(handle: "watch-1") {\n        products(first: 12) {\n          nodes {\n            id\n            title\n            handle\n            featuredImage {\n              url\n              altText\n              width\n              height\n            }\n            options {\n              name\n              optionValues {\n                name\n              }\n            }\n            variants(first: 100) {\n              nodes {\n                id\n                title\n                availableForSale\n                price {\n                  amount\n                  currencyCode\n                }\n                selectedOptions {\n                  name\n                  value\n                }\n                image {\n                  url\n                  altText\n                  width\n                  height\n                }\n              }\n            }\n          }\n        }\n      }\n      braceletCollection: collection(handle: "bracelet-1") {\n        products(first: 12) {\n          nodes {\n            id\n            title\n            handle\n            featuredImage {\n              url\n              altText\n              width\n              height\n            }\n            options {\n              name\n              optionValues {\n                name\n              }\n            }\n            variants(first: 100) {\n              nodes {\n                id\n                title\n                availableForSale\n                price {\n                  amount\n                  currencyCode\n                }\n                selectedOptions {\n                  name\n                  value\n                }\n                image {\n                  url\n                  altText\n                  width\n                  height\n                }\n              }\n            }\n          }\n        }\n      }\n    }\n  ': {
    return: BundleCollectionsQuery;
    variables: BundleCollectionsQueryVariables;
  };
